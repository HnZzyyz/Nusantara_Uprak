...
public class Member {
    ...
    public Member(String member_id, String nama, String tanggal_lahir, String alamat, String nomor_telepon, String jenis_kelamin, String agama, int province_id, int regencies_id, int districts_id) {
